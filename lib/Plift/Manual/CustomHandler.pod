...
This page describes how to attach custom handlers on the L<Plift> template engine.
...
expressions and triggering the associated subroutine.
...
Custom handlers are just a fancy name for a subroutine attached to some xpath
expression.
